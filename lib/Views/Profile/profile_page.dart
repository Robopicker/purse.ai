  ...
  Widget optionCta(dynamic image, String title, [onPressed]) {
    return GestureDetector(
      ...
      child: Column(
        ...
        children: [Icon(image), Container(margin: const EdgeInsets.only(left: 25),child: Text(title, style: temp['optionTextStyle'],)) ],
      ),
  ...
  Widget userInfo() {
    return Column(
      children: [
        ...
        optionCta(Icons.verified_user_outlined, 'Your Profile ', onProfilePressed),
                        ...
                        Align(alignment: Alignment.centerRight, child:  GestureDetector(
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: const Text('Cancel', style: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w500),),
                            ),
                          ),
...
final temp = {
  'textStyle': const TextStyle(color: Colors.red, fontSize: 16, fontWeight: FontWeight.w500,),
  'userTextStyle': const TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w500),
  'optiontextStyle': const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.black),
  'optionTitleStyle': const TextStyle(color: Color.fromRGBO(156, 164, 171, 1), fontSize: 14, fontWeight: FontWeight.w500)
};